...
https://make.wordpress.org/test/glossary/#mobile-abandonment [#](https://make.wordpress.org/test/handbook/glossary/#mobile-abandonment)

## Pain point
Pain points are “places where you know from research or analytics that users are currently getting hung up and have to ask questions, or are likely to abandon the site or app.” — Design for Real Life [#](https://make.wordpress.org/test/handbook/glossary/#pain-point)
## Rogue cursor
...
https://make.wordpress.org/test/tag/user-anecdote/ [#](https://make.wordpress.org/test/handbook/glossary/#user-anecdote)

## Visual history
A visual history shows the evolution of an interface over time and across releases. [#](https://make.wordpress.org/test/handbook/glossary/#visual-history)
...
https://make.wordpress.org/test/2015/04/03/remove-a-widget-with-the-customizer-iphone-6/ [#](https://make.wordpress.org/test/handbook/glossary/#visual-record)
