...
**Share any relevant announcements (e.g. a new WordPress version, a beta release, release candidate)**
...
<div class="callout callout-info">
Assign one ticket at a time per participant. Wait for them to reply or post a report before assigning a new one. Keep and eye on the thread throughout the session.
</div>
...
- **Close gracefully:** give a clear end message so participants know when hosted portion is done, even if testing continues
